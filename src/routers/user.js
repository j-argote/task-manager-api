...
router.patch ('/users/me', auth, async (req, res) => {
    ...
    // Setting up allowed properities to update
...
// Multer file handler configuration
const upload = multer({
    limits: {
        fileSize: 1000000
    },
...
// Create avatar or update avatar with uniform size and extension
